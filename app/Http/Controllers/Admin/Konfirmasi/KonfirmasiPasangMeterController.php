...
class KonfirmasiPasangMeterController extends Controller
{
    ...
    public function pembayaranDp($user, $nominal, $layanan)
    {
        ...
        $data = [
            'phone' => $user->no_telp,
            'message' => 'Salam, Kami Pihak PT. SUMBER SAE SATU menyampaikan bahwa Uang Muka anda telah terbayarkan pada pelayanan '. $layanan .' Baru sebesar Rp. ' . number_format($nominal, 0),
        ];
