...
<div class="col-lg-12">
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-lg-12">
                    <form action="{{ route('admin.list_permohonan.k_instalasi_bangunan.store', $ib->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                        <div class="row">
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="nr" class="form-control shadow" readonly value="{{ $ib->nomor_registrasi }}">
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    <label for="nl">Jenis Instalasi:</label>
                                                    <input type="text" name="jp" class="form-control shadow" readonly value="{{ Str::title($ib->jenis_instalasi)}}">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
