...
<div class="col-lg-12">
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-lg-12">
                    <form action="{{ route('admin.list_permohonan.k_service_listrik_bangunan.store', $slb->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                        <div class="row">
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" name="nr" class="form-control shadow" readonly value="{{ $slb->nomor_registrasi }}">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    <label for="nl">Jenis Service:</label>
                                                    <input type="text" name="jp" class="form-control shadow" readonly value="{{ Str::title($slb->jenis_service)}}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="alamat" id="" class="form-control shadow" cols="30" rows="5">{{ $slb->alamat }}</textarea>
                                </div>

                                @if ($slb->JenisKerusakan()->exists())
                                    <h5>Jenis Kerusakan:</h5>
                                    @foreach ($slb->JenisKerusakan as $jk)
