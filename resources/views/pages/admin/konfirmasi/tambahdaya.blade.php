...
<div class="col-lg-12">
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-lg-12">
                    <form action="{{ route('admin.list_permohonan.k_tambah_daya.store', $td->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                        <div class="row">
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    <label for="nl">Tarif Lama:</label>
                                                    <input type="text" name="tb" class="form-control shadow" readonly value="{{ $td->tarif_lama}}">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    <label for="nl">Tarif Baru:</label>
                                                    <input type="text" name="tb" class="form-control shadow" readonly value="{{ $td->tarif_baru }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    <label for="nl">Daya Lama:</label>
                                                    <input type="text" name="db" class="form-control shadow" readonly value="{{ $td->daya_lama}}">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    <label for="nl">Daya Baru:</label>
                                                    <input type="text" name="db" class="form-control shadow" readonly value="{{ $td->daya_baru }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="alamat" id="" class="form-control shadow" cols="30" rows="5">{{ $td->lokasi_meter }}</textarea>
                                </div>
