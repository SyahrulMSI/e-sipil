                                                        ...
                                                        <div class="modal fade" id="delete{{ $t->id }}" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                            <div class="modal-dialog">
                                                              <div class="modal-content">
                                                                ...
                                                                <form action="{{ route('admin.add_petugas_ib.destroy', $t   ->id) }}" method="POST" enctype="multipart/form-data">
                                                                    @csrf
                                                                    @method('DELETE')
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <form action="{{ route('admin.list_permohonan.add_petugas_ib.store', $ib->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('POST')
