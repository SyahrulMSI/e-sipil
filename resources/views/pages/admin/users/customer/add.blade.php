            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="btn-group mb-3">
                        <a href="{{ route('admin.customer.index') }}" class="btn btn-warning font-weight-bold btn-sm"><i class="fa fa-arrow-circle-left"></i> Kembali</a>
                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" type="no_telp" class="form-control {{ $errors->has('no_telp') ? 'is-invalid' : '' }} shadow" value="{{ old('no_telp') }}">
                                            @error('no_telp')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
