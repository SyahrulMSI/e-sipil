            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="btn-group mb-3">
                        <a href="{{ route('admin.customer.create') }}" class="btn btn-success btn-sm"><i class="fa fa-plus-circle"></i> Tambah Data</a>
                    </div>
                            ...
                            <tbody>
                               ...
                               @foreach ($users as $us)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a href="{{ route('admin.customer.show', $us->id) }}" class="btn btn-primary btn-sm  rounded"><i class="fa fa-eye"></i></a>
                                                &nbsp;
                                                <a href="{{ route('admin.customer.edit', $us->id) }}" class="btn btn-warning btn-sm  rounded"><i class="fa fa-edit"></i></a>
                                                &nbsp;
