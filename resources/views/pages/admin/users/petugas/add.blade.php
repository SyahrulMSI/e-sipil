        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header bg-primary">
                    <h5 class="card-title text-white fomt-weight-bold">Tambah Petugas</h5>
                </div>
                <div class="card-body">
                    <div class="btn-group mb-3">
                        <a href="{{ route('admin.petugas.index') }}" class="btn btn-warning font-weight-bold btn-sm"><i class="fa fa-arrow-circle-left"></i> Kembali</a>
                    </div>
