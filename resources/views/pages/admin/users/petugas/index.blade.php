            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="btn-group mb-3">
                        <a href="{{ route('admin.petugas.create') }}" class="btn btn-success btn-sm"><i class="fa fa-plus-circle"></i> Tambah Data</a>
                    </div>
                                                ...
                                                <div class="modal-dialog">
                                                  <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                      ...
                                                      <form action="{{ route('admin.petugas.destroy', $us->id) }}" method="POST" id="hapus">
                                                        @csrf
                                                        @method('DELETE')
                                                      </form>
                                                    </div>
