      ...
      <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-12">
                        <form action="{{ route('customer.my_profile.update', Auth::user()->id ) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <form action="{{ route('customer.detail_profile.update', Auth::user()->DetailUser()->first()->id) }}" id="update_du" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                        @else
                        <form action="{{ route('customer.detail_profile.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('POST')
                        @endif
